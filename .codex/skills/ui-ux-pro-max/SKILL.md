---
name: ui-ux-pro-max
description: "UI/UX design intelligence with searchable database of 50 styles, 21 palettes, 50 font pairings, 20 chart types, and 8 stack-specific guides. Focuses on visual design decisions, not business logic or backend code. Use when the user asks to design, build, review, or improve UI components, create layouts, choose color palettes, select typography, or apply design styles (glassmorphism, minimalism, brutalism, dark mode, etc.) for websites, dashboards, landing pages, mobile apps, or SaaS products using React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, or Tailwind CSS."
---
